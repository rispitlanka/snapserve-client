...
export const metadata: Metadata = {
  title: "Menu Category",
  description: "Menu category management is coming soon",
};
...
export default function ManageMenuCategoryPage() {
  return (
    <section className="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/3">
      ...
      <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">Upcoming: menu category management will be available here soon.</p>
    </section>
  );
}
